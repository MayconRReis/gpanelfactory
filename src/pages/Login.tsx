        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-[#a1a1aa] text-[10px] uppercase tracking-widest font-bold">
                Email
              </Label>
              <Input
                id="email"
            ...
            {isRegistering && (
              <div className="space-y-2">
                <Label htmlFor="name" className="text-[#a1a1aa] text-[10px] uppercase tracking-widest font-bold">
                  Nome
                </Label>
                <Input
                  id="name"
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-[#a1a1aa] text-[10px] uppercase tracking-widest font-bold">
                Senha
              </Label>
              <Input
                id="password"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold uppercase tracking-widest text-[11px] shadow-[0_0_10px_rgba(37,99,235,0.2)] disabled:opacity-50"
            >
              {isLoading ? 'Aguarde...' : isRegistering ? 'Registrar' : 'Entrar'}
            </Button>
            <Button
              type="button"
              variant="link"
