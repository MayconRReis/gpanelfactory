...
export function LeaderScreen() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0a0a0c] text-[#f4f4f5] flex items-center justify-center font-sans">
        Carregando...
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#0a0a0c] text-[#f4f4f5] flex flex-col items-center justify-center p-4 font-sans">
          ...
          <>
            ...
            <div className="bg-[#121214] border border-[#27272a] p-5 rounded-xl text-left mb-8">
              ...
              <div className="mt-4">
                ...
                <div className="flex justify-between text-[10px] mt-2 text-[#71717a] font-mono font-bold">
                  <span>
                    {op.producedQuantity} / {op.plannedQuantity} un
                  </span>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              {op.status === 'pending' ? (
                <Button
                  onClick={handleStart}
                  className="col-span-2 h-14 bg-green-600 hover:bg-green-500 text-white font-bold uppercase tracking-widest text-[11px] shadow-[0_0_10px_rgba(34,197,94,0.2)]"
                >
                ...
                <>
                  <Button
                    ...
                    className="h-14 bg-[#18181b] border border-orange-500/30 text-orange-500 hover:bg-orange-500/10 font-bold uppercase tracking-widest text-[11px]"
                  >
                    <Pause className="w-4 h-4 mr-2" /> PAUSAR
                  </Button>
                  <Button
                    onClick={() => setIsReportOpen(true)}
                    className="h-14 bg-blue-600 hover:bg-blue-500 text-white font-bold uppercase tracking-widest text-[11px] shadow-[0_0_10px_rgba(37,99,235,0.2)]"
                  >
                    <Package className="w-4 h-4 mr-2" /> APONTAR
                  </Button>
                  <Button
                    onClick={() => setIsFinishOpen(true)}
                    className="col-span-2 h-14 mt-2 bg-[#18181b] border border-[#27272a] text-[#f4f4f5] hover:bg-[#27272a] font-bold uppercase tracking-widest text-[11px]"
                  >
                ...
                <Button
                  ...
                  className="col-span-2 h-14 bg-blue-600 hover:bg-blue-500 text-white font-bold uppercase tracking-widest text-[11px] shadow-[0_0_10px_rgba(37,99,235,0.2)]"
                >
      ...
      <Dialog open={isPauseOpen} onOpenChange={setIsPauseOpen}>
        <DialogContent className="bg-[#18181b] border-[#27272a] text-[#f4f4f5]">
          <DialogHeader>
            <DialogTitle className="uppercase tracking-widest text-sm font-bold text-orange-500">
              Registrar Pausa
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            ...
            <Button
              ...
              className="w-full bg-orange-600 hover:bg-orange-500 text-white font-bold uppercase tracking-widest text-[11px] disabled:opacity-50"
            >
              Confirmar Pausa
            </Button>
          </div>
        ...
        <DialogContent className="bg-[#18181b] border-[#27272a] text-[#f4f4f5]">
          ...
          <div className="space-y-4 py-4">
            ...
            <Button
              ...
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold uppercase tracking-widest text-[11px] disabled:opacity-50"
            >
      ...
      <Dialog open={isFinishOpen} onOpenChange={setIsFinishOpen}>
        <DialogContent className="bg-[#18181b] border-[#27272a] text-[#f4f4f5]">
          <DialogHeader>
            <DialogTitle className="uppercase tracking-widest text-sm font-bold text-green-500">
              Finalizar Ordem
            </DialogTitle>
          </DialogHeader>
          <div className="py-4">
            <p className="text-sm text-[#a1a1aa] mb-6">
              Você tem certeza que deseja finalizar a OP {op?.number}? Esta ação não pode ser desfeita.
            </p>
            <div className="flex gap-4">
              <Button
                onClick={() => setIsFinishOpen(false)}
                variant="outline"
                className="flex-1 border-[#27272a] hover:bg-[#27272a] hover:text-white uppercase text-[11px] font-bold tracking-widest"
              >
                Cancelar
              </Button>
              <Button
                onClick={handleFinish}
                className="flex-1 bg-green-600 hover:bg-green-500 text-white uppercase text-[11px] font-bold tracking-widest"
              >
